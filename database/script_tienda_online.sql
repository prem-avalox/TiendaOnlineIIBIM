-- ================================================
-- BASE DE DATOS: TIENDA ONLINE DE PRENDAS MASCULINAS
-- ================================================
...
-- Insertar usuario de prueba (contraseña: cliente123)
INSERT INTO usuarios (nombre_completo, correo, contrasena, rol) 
VALUES ('Juan Pérez', 'juan@example.com', 'cliente123', 'CLIENTE');
...
-- ================================================
-- Nota: Pantalones de la tienda real tienen sus propias tallas
INSERT INTO tallas (id_prenda, talla, stock) VALUES
-- Pantalón Denim Crudo (tallas estándar S-XL)
...
-- ================================================
-- Nota: Calzado con tallas de tamaño estándar
INSERT INTO tallas (id_prenda, talla, stock) VALUES
...
-- Ver todas las prendas con sus tallas
SELECT p.nombre, p.categoria, t.talla, t.stock
FROM prendas p
LEFT JOIN tallas t ON p.id_prenda = t.id_prenda
ORDER BY p.id_prenda, t.talla;

-- Ver prendas sin stock
SELECT p.nombre, t.talla
FROM prendas p
INNER JOIN tallas t ON p.id_prenda = t.id_prenda
WHERE t.stock = 0;
